...
/**
 * Event observer for format_weeksrev.
 *
 * @package format_weeksrev
 * @copyright 2017 Mark Nelson <markn@moodle.com>
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class format_weeksrev_observer {
    ...
    public static function course_updated(\core\event\course_updated $event) {
        if (class_exists('format_weeksrev', false)) {
            // If class format_weeksrev was never loaded, this is definitely not a course in 'weeks' format.
            // Course may still be in another format but format_weeksrev::update_end_date() will check it.
            format_weeksrev::update_end_date($event->courseid);
        }
    }
